...
{
    static const opcua::DataType dt = opcua::DataTypeBuilder<variable1>::createStructure("variable1", {1, 1}, {1, 4023})
...
{
    static const opcua::DataType dt = opcua::DataTypeBuilder<variable2>::createStructure("variable2", {1, 2}, {1, 4024})
...
template <> struct TypeConverter<variable1>
{
    ...
    static void toNative(const ValueType &src, NativeType &dst)
    {
        ...
        dst.content.encoded.typeId =
            UA_NODEID_NUMERIC(variable1NodeIdInfo.namespaceIndex, variable1NodeIdInfo.identifier);
    }
};

template <> struct TypeConverter<variable2>
{
    ...
    static void toNative(const ValueType &src, NativeType &dst)
    {
        ...
        // Set Type ID (if necessary, example given below)
        dst.content.encoded.typeId =
            UA_NODEID_NUMERIC(variable2NodeIdInfo.namespaceIndex, variable2NodeIdInfo.identifier);
    }
};
